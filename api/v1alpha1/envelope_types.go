...
// EnvelopeSpec defines the desired state of Envelope.
type EnvelopeSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of Envelope. Edit envelope_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// EnvelopeStatus defines the observed state of Envelope.
...
// Envelope is the Schema for the envelopes API.
